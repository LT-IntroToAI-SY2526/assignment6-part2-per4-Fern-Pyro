...
def visualize_features(data):
    ...
    """
    fig, axes = plt.subplots(2, 2, figsize=(12, 10))# TODO: Create a figure with 2x2 subplots, size (12, 10)
    ...
    axes[0,1].scatter(data['Bedrooms'], data['Price'], color='red', alpha=0.6)
